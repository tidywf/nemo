...
test_that("Function parse_file_nohead() @ L95", {
...
test_that("Function file_hdr() @ L154", {
...
test_that("Function schema_guess() @ L195", {
...
test_that("Function parse_file_keyvalue() @ L257", {
