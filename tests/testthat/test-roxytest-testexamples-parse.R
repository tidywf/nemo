...
test_that("Function parse_file() @ L55", {
...
test_that("Function parse_file_nohead() @ L107", {
...
test_that("Function file_hdr() @ L161", {
...
test_that("Function schema_guess() @ L202", {
...
test_that("Function parse_file_keyvalue() @ L267", {
