...
Its R6 classes (`Tool`, `Workflow`, `Config`) form the base layer: given a directory
of bioinformatic results, they identify files by YAML-defined schemas, reshape
and rename columns to a consistent tidy form, and write to a specified format
...
and parsers. [tidywigits] and [tidydragen] are example R packages
